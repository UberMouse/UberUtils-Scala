...
public class PCheckBox extends PComponent
{
    ...
    private static final Color OFF       = new Color(10, 10, 10, 240);
    private static final Color OFF_HOVER = new Color(55, 55, 55, 240);
    private static final Color ON        = new Color(200, 200, 200, 85);
    private static final Color ON_HOVER  = new Color(110, 110, 110, 120);
