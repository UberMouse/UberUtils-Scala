...
public class Options
{
    ...
    public static void add(String s, long l) {
    ...
    public static void add(String s, float f) {
    ...
    public static void add(String s, byte[] bytes) {
    ...
    public static void put(String s, long l) {
        prefs.putLong(s, l);
        longDefaults.put(s, l);
        save();
    }
    ...
    public static void put(String s, double v) {
        prefs.putDouble(s, v);
    ...
    public static void put(String s, byte[] bytes) {
