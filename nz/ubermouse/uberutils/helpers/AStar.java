...
public class AStar
{
    public static final int WALL_NORTH_WEST = LocalPath.WALL_NORTH_WEST;
    public static final int WALL_NORTH = LocalPath.WALL_NORTH;
    public static final int WALL_NORTH_EAST = LocalPath.WALL_NORTH_EAST;
    public static final int WALL_EAST = LocalPath.WALL_EAST;
    public static final int WALL_SOUTH_EAST = LocalPath.WALL_SOUTH_EAST;
    public static final int WALL_SOUTH = LocalPath.WALL_SOUTH;
    public static final int WALL_SOUTH_WEST = LocalPath.WALL_SOUTH_WEST;
    public static final int WALL_WEST = LocalPath.WALL_WEST;
    public static final int BLOCKED = LocalPath.BLOCKED;
