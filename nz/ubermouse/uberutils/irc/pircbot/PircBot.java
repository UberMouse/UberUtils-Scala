...
package nz.ubermouse.uberutils.irc.pircbot;
...
public abstract class PircBot implements ReplyConstants
{
    ...
    public final synchronized void connect(String hostname,
                                           int port) throws IOException, IrcException, NickAlreadyInUseException {
    ...
    public final synchronized void connect(String hostname,
                                           int port,
                                           String password) throws IOException, IrcException, NickAlreadyInUseException {
...
//        if (Gui.instance() != null && Gui.instance().userListPane != null)
//            Gui.instance().addContentText(Color.GREEN, line + "\n");
    }
     ...
     */
    private final void processMode(String target,
                                   String sourceNick,
                                   String sourceLogin,
                                   String sourceHostname,
                                   String mode) {
